...
import type { CoreCloudGeometryPayload, CoreCloudSolveRequest, CoreVolumeMeshArtifact } from "../types";
import {
...
export async function generateCoreVolumeMeshFromGeometry(
  ...
  _request: Pick<CoreCloudSolveRequest, "analysisType" | "study" | "displayModel" | "solverSettings">
